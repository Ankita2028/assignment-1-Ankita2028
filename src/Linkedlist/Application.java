 ...
 *
 * @parameter firstName     will add firstName of the Person in the contactList
 * @parameter secondName      will add lastName of the Person in the contactList
 * @parameter contactNumber will add  contactNumber of the Person in the contactList
 * @parameter emailAddress  will add emailAddress of the Person in the contactList
 */
  ...
  public void addFirstName(String firstName) {
    ...
    public void addEmailAddress(String emailAddress) {
        contactList.add(new Person(emailAddress));
    }
